...
//
int DHT22::readSensor(unsigned long currentTime)
{
...
float DHT22::getTemperature(bool celsius)
{
  if(!celsius) {
    return _lastTemperature * 1.8 + 32;
  }
...
//
void DHT22::clockReset(unsigned long timeInMillis)
{
